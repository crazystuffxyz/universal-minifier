...
SOURCE_EXEC_NAME="uniminify-linux"
...
echo
echo "[DONE] For the PATH change to take effect, please run 'source $HOME/.bashrc'"
echo "       (or 'source $HOME/.zshrc') or open a new terminal."
